...
public class BigWidget extends BaseWidget {
    ...
    private static final String TAG = "BigWidget ";
    ...
    protected void onViewsUpdate(Context context, RemoteViews remoteViews, ComponentName serviceName, Bundle extras) {
        ...
        remoteViews.setOnClickPendingIntent(R.id.btnNext_black, PendingIntent.getService(
                context,
                REQUEST_NEXT,
                new Intent(context, MusicController.class)
                        .setAction(ACTION_NEXT)
        ...
        remoteViews.setOnClickPendingIntent(R.id.btnPlay_black, PendingIntent.getService(
                context,
                REQUEST_PLAY_PAUSE,
                new Intent(context, MusicController.class)
                        .setAction(ACTION_PLAY_PAUSE)
        ...
        remoteViews.setOnClickPendingIntent(R.id.btnPrevious_black, PendingIntent.getService(
                context,
                REQUEST_PREVIEW,
                new Intent(context, MusicController.class)
                        .setAction(ACTION_PREVIOUS)
